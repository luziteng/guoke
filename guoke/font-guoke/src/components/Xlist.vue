<template>
    ...
    <div class="container" id="container">
            ...
            <a class="list" href="#"  v-for="card of cards">
                <div class="list-top">{{card.date}}</div>
                ...
                cards:[
                    {
                        ...
                        title:"6.97吨碳九泄漏，危害会有多大？",
                        content:"11月4日凌晨，福建泉州码头的一艘石化产品运输船发生泄漏，6.97吨碳九产品漏入近海，造成水体污染。许多居民在微博上求助，网友们也十分关心这次泄漏的危害。本文主要内容：1. 碳九是一系列含碳数量在9左右的碳氢化合物，是提炼石油获得的。2. 碳九有两种，裂解碳九和重整碳九；泄露的是哪种碳九，是污染问题的关键" ,
                    ...
                    },
                    {
                        ...
                        date:"2018-10-26",
                        flex:true,//判断是否存在<div class="flex">
                        title:"人体内发现微塑料？不仅侵入血液、肝脏等，它还有哪些危害？",
                        content:"新研究首次在人体粪便中检测到多达9种微塑料" ,
                    ...
                    },
                    {
                        ...
                        title:"“抽动秽语综合征”都被拿来骂人了，能别这么叫我吗？",
                        content:"妥瑞氏症也许是他们的“终身伴侣”，但他们，绝不仅仅是妥瑞氏症患者。" ,
                        ShowImg:false,//判断是否有<div class="list-right">
                        url:"https://v.qq.com/txp/iframe/player.html?vid=f0741oigwkq",
                    ...
                    },
                    {
                        ...
                        date:"2018-10-18",
                        flex:true,//判断是否存在<div class="flex">
                        title:"“造假十多年，撤稿31篇，这位心机大牛因何骗过全世界？",
                        content:"十几年来，数不清的人力、物力、财力投入，最后只换来一堆无法自圆其说又毫无实践意义的论文。不仅仅是对社会资源的浪费，更耽误了这一领域的科研进程，让无数学者深受其害。" ,
                        ShowImg:true,//判断是否有<div class="list-right">
                        url:w3,
                        video:false,//判断是否有<div class="video"">
                        middleVideo:false,//判断是否有 <div class="list-middle list-middle-video">
                    },
                    {
                        ...
                        date:"2018-10-03",
                        flex:true,//判断是否存在<div class="flex">
                        title:"林章凛、尹航、胡家志热评诺奖：他们驯化了演化的力量！",
                        content:"让演化的力量为人所用" ,
                        ShowImg:true,//判断是否有<div class="list-right">
                        url:w4,
                        video:false,//判断是否有<div class="video"">
                    ...
                    },
                    {
                        ...
                        date:"2018-10-03",
                        flex:true,//判断是否存在<div class="flex">
                        title:"口水也能得诺奖？诺贝尔搞笑奖，为啥这么不正经？",
                        content:"口水真的具有清洁作用？它能清洁什么？" ,
                        ShowImg:true,//判断是否有<div class="list-right">
                        url:w5,
                        video:false,//判断是否有<div class="video"">
                        middleVideo:false,//判断是否有 <div class="list-middle list-middle-video">
